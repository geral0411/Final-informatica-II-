/*
 ...
 Clase Personaje: personaje principal el cual posee movimientos de caminar a la derecha y
...
void Personaje::activar_time()
{
    time->start(T*1000);
}

void Personaje::desactivar_time()
{
    time->stop();
}
